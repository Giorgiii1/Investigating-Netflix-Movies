...
const seats_div = document.querySelector('#seat')
seats_div.classList.add('grid-container')

seat_fun(seats)

function seat_fun (seats){

  seats.forEach((seat)=>{
  
    const seatEl = document.createElement('button')
    seatEl.classList.add('grid-item')
    ...
    console.log('innerHtml',seatEl.innerHTML)
    seats_div.appendChild(seatEl)
    seatEl.addEventListener('click', ()=>{
    
    localStorage.setItem('seat', seat.id)
